//--------------------------------------------------------------------
//Program: Cullowhee Trails - fishing.js
//Programmers: Thanh Tram
//Date: 11/15/2013
//Description: Javascript file for the fishing.html page
//--------------------------------------------------------------------
...
function displayArray(parArray) {
    ...
    while (arrayIndex < parArray.length) {
        ...
        display += '<li id="' + catTitle.replace(/\s+/g, '') + '" ><a class="list-group-item"  href="poiList.html?qryCatCode=' + catCode + '&qryCatTitle=' + catTitle + '" rel="external">' +
